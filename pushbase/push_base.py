...
class PushBase(ControlSurface):
    ...
    def _create_slicing_modes(self):
        ...
        slicing_modes.add_mode('64pads', [
         AddLayerMode(self._slicing_component, Layer(matrix='matrix')),
         LayerMode(self._pitch_mod_touch_strip, self._pitch_mod_touch_strip_layer)], message=consts.MessageBoxText.LAYOUT_SLICING_64_PADS)
        slicing_modes.add_mode('sequencer_loop', [
         self._slice_step_sequencer,
    ...
    def _init_matrix_modes(self):
        ...
        self._drum_modes.add_mode('sequencer_loop', [
        ...
        self._drum_modes.add_mode('sequencer_velocity_levels', [
         self._drum_step_sequencer,
         self._note_editor_settings_component,
    ...
    def _create_clip_mode(self):
        return [
         self._when_track_is_not_frozen(partial(self._view_control.show_view, 'Detail/Clip'), LazyComponentMode(self._create_clip_control))]
